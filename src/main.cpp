...
// Copyright (c) 2011-2013 GLDcoin Developers
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if(nHeight > 673700)   // after 673700 blocks, no more mining
        return 0;

    if(nHeight <= 200)   // The big bonus blocks
    {
        nSubsidy = 10000 * COIN;
    }
    else if(nHeight > 200 && nHeight <= 2200)   // 1000 coins
    {
        nSubsidy = 1000 * COIN;
    }
    else if(nHeight > 2200 && nHeight <= 26200)   // 500 coins
    {
        nSubsidy = 500 * COIN;
    }
    else if(nHeight > 26200 && nHeight <= 48700)   // 400 coins
        {
            nSubsidy = 400 * COIN;
    }
    else if(nHeight > 48700 && nHeight <= 173700)   // 200 coins
        {
            nSubsidy = 200 * COIN;
    }
    else if(nHeight > 173700)   // 100 coins
        {
            nSubsidy = 100 * COIN;
    }
...
static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // GLDcoin: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // GLDcoin: 2.5 minutes
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        assert(block.hashMerkleRoot == uint256("0xa215e67ba165202f75b6458d22fedd1a3ec4f03449a4c6b2a4b8130bfebd3b15"));
